const questions = [
    { question: '미술 시간에 그림 그리거나, PPT 디자인을 꾸미는 걸 즐기거나 잘한다고 생각하나요?', answers: ['Yes', 'No'], fields: { Yes: {'프론트엔드 개발': 2, '그래픽스 프로그래밍': 1}, No: {'백엔드 개발': 1, '데이터 과학': 1} } },
    { question: '숫자나 데이터를 가지고 무언가를 분석하거나, 통계를 내는 걸 좋아하나요? 예를 들어, 친구들 사이에서 설문조사를 하고 결과를 정리하는 걸 즐기나요?', answers: ['Yes', 'No'], fields: { Yes: {'데이터 과학': 2, '비즈니스 인텔리전스': 2, '인공지능 개발': 1}, No: {'프론트엔드 개발': 1, '게임 개발': 1} } },
    { question: '게임을 하다가 "내가 이런 게임을 만들면 더 재밌게 만들 텐데!"라는 생각을 해본 적이 있나요?', answers: ['Yes', 'No'], fields: { Yes: {'게임 개발': 2, '그래픽스 프로그래밍': 1, 'VR/AR 개발': 1}, No: {'풀스택 개발': 1, '모바일 앱 개발': 1} } },
    { question: '영화 속 인공지능 로봇(예: 아이언맨의 자비스)처럼 똑똑한 시스템을 만들어보고 싶다는 생각이 드나요?', answers: ['Yes', 'No'], fields: { Yes: {'인공지능 개발': 2, '자연어 처리': 2, '머신러닝': 1}, No: {'풀스택 개발': 1, '데이터베이스 관리': 1} } },
    { question: '인터넷에서 사진이나 파일을 저장하고 어디서든 꺼내 쓸 수 있는 시스템(예: 구글 드라이브)을 만들어보고 싶나요?', answers: ['Yes', 'No'], fields: { Yes: {'클라우드 컴퓨팅': 2, '백엔드 개발': 1, '데이터베이스 관리': 1}, No: {'임베디드 시스템': 1, '네트워크 엔지니어링': 1} } },
    { question: '영화 속 해커처럼 시스템을 보호하거나, 누군가의 공격을 막는 역할이 멋지다고 생각하나요?', answers: ['Yes', 'No'], fields: { Yes: {'사이버 보안': 2, '네트워크 엔지니어링': 1, '시스템 프로그래밍': 1}, No: {'풀스택 개발': 1, '모바일 앱 개발': 1} } },
    { question: '"포켓몬 GO"처럼 현실과 가상세계를 결합한 기술에 흥미가 있나요?', answers: ['Yes', 'No'], fields: { Yes: {'VR/AR 개발': 2, '모바일 앱 개발': 1, '게임 개발': 1}, No: {'풀스택 개발': 1, '데이터베이스 관리': 1} } },
    { question: '비트코인 같은 암호화폐나 블록체인 기술이 흥미롭다고 느껴지나요?', answers: ['Yes', 'No'], fields: { Yes: {'블록체인 개발': 2, '암호학': 1, '핀테크 개발': 1}, No: {'풀스택 개발': 1, '데이터베이스 관리': 1} } },
    { question: '컴퓨터가 반복적으로 해야 하는 일을 대신해주는 프로그램(예: 엑셀 매크로)을 만들어보고 싶다고 생각한 적이 있나요?', answers: ['Yes', 'No'], fields: { Yes: {'RPA': 2, '스크립팅': 1, '자동화 테스트': 1}, No: {'풀스택 개발': 1} } },
    { question: '"시리"나 "구글 어시스턴트"처럼 말을 알아듣고 대답하는 프로그램을 만들어보고 싶다고 생각하나요?', answers: ['Yes', 'No'], fields: { Yes: {'자연어 처리': 2, '인공지능 개발': 1, '음성 인식': 1}, No: {'풀스택 개발': 1, '데이터베이스 관리': 1} } },
    { question: '"혼자서 웹사이트나 앱 전체를 만들 수 있다면 멋질 것 같다"고 생각하신 적이 있나요?', answers: ['Yes', 'No'], fields: { Yes: {'풀스택 개발': 2, '프론트엔드 개발': 1, '백엔드 개발': 1}, No: {'데이터 과학': 1, '시스템 프로그래밍': 1} } },
    { question: '"유튜브 추천 영상"이나 "넷플릭스 추천 영화"처럼 사람들에게 딱 맞는 것을 추천해주는 프로그램이 흥미롭다고 생각하나요?', answers: ['Yes', 'No'], fields: { Yes: {'추천 시스템': 2, '머신러닝': 1, '데이터 과학': 1}, No: {'풀스택 개발': 1, '네트워크 엔지니어링': 1} } },
    { question: '"카카오페이"나 "토스" 같은 서비스처럼 돈 관리와 결제를 더 편리하게 만드는 프로그램이 흥미롭다고 느껴지나요?', answers: ['Yes', 'No'], fields: { Yes: {'핀테크 개발': 2, '모바일 앱 개발': 1, '보안 프로그래밍': 1}, No: {'데이터 과학': 1, '시스템 프로그래밍': 1} } },
    { question: '"픽사 애니메이션"이나 "3D 게임 그래픽"처럼 멋진 시각 효과를 만들어보고 싶다는 생각이 드시나요?', answers: ['Yes', 'No'], fields: { Yes: {'그래픽스 프로그래밍': 2, '게임 개발': 1, 'VR/AR 개발': 1}, No: {'백엔드 개발': 1, '데이터베이스 관리': 1} } }
];
...
const recommendations = {
    ...
    '음성 인식': 'Python과 음성 처리 라이브러리(예: librosa, pydub)를 학습하세요. 신호 처리와 음성학 기초도 공부하면 도움이 됩니다.',
